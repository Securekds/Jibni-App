...
import { CurrentLanguage } from '@/types/auth';
import { useTranslation } from 'react-i18next';
import { useI18n } from '@/translations';

type LanguageOption = {
  id: CurrentLanguage;
  flag: ImageRequireSource;
};
...
const languages: LanguageOption[] = [
  ...
  {
    id: 'ar',
    flag: require('@/assets/algeria.png'),
  },
];
...
const SelectLanguageScreen: React.FC = () => {
  ...
  return (
    <Box flex={1} backgroundColor={'primary'} style={{}}>
      ...
      {isBoxVisible && (
        ...
        >
          <Text variant="header" style={{direction: "rtl"}}>{t('language.selectLanguage')}</Text>
          <Text variant="subheader" style={{ fontSize: 16, direction: "rtl" }} marginBottom={'l'}>
